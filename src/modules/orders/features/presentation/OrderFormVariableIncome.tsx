...
export const OrderFormVariableIncome = ({
  useNeumorphism,
  createItem,
}: OrderFormVariableIncomeProps) => {
  ...
  const typeActionSelect = new SelectBuilder()
...
export default OrderFormVariableIncome;
